...
exports.cookieExtractor = function (req) {
    ...
    // token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2N2U4ZjRlNjZhODYwZDNiZTIzMWQ1NCIsInJvbGUiOiJ1c2VyIiwiaWF0IjoxNzE5ODI5ODMxfQ.6-Z756cUv8wQvu2dS6dTqp_nCiMi90V0Jiv1UttzFWY";
    return token;
}
...
exports.sendMail = async function ({to, subject, text, html}) {
    ...
    let info = await transporter.sendMail({
        from: '"E-commerce Team" <jamesnagar11@gmail.com>', // sender address
        to, 
        subject, 
        text: 'Yo boi',
        html 
